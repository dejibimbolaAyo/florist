            ...
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{headless_url('admin/products/edit/'.$product->id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" value="{{$product->name}}" required name="name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" min="10" class="form-control1" id="focusedinput" value="{{$product->price}}" required name="price"
                                placeholder="Price">
                        </div>
                        <div class="col-sm-2">
